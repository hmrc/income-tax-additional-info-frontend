...
import views.html.pages.gains.PolicyAddPageView

class PolicyAddPageViewSpec extends ViewUnitTest {

  private val page: PolicyAddPageView = inject[PolicyAddPageView]
  ...
  object CommonExpectedCY extends CommonExpectedResults {
    ...
    override val expectedSummaryListChangeLink: String = "Newid Change the policy details"
    override val expectedSummaryListRemoveLink: String = "Tynnu Remove the policy"
