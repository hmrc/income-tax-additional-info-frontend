...
object BusinessReliefsNonDeductibleMessages {
  ...
  sealed trait Messages { _: i18n =>
    ...
    val p3 = "For more information, visit Helpsheet 340 and read the section titled Residential property finance cost restriction."
    val label = "How much is the non-deductible loan interest from interest investments into property letting partnerships?"
  ...
  object EnglishAgent extends Messages with En {
    ...
    override val amountTooLarge = "The amount of your clients non-deductible loan interest must be less than £100,000,000,000"
  }
  ...
  object Welsh extends Messages with Cy {
    ...
    override val p3 = "For more information, visit Helpsheet 340 and read the section titled Residential property finance cost restriction. (Welsh)"
    override val label = "How much is the non-deductible loan interest from interest investments into property letting partnerships? (Welsh)"
  ...
  object WelshAgent extends Messages with Cy {
    ...
    override val amountEmpty = "Enter the value of the non-deductible loan interest (Welsh)"
    override val amountInvalid = "Non-deductible loan interest must only include the numbers 0-9 and a decimal point (Welsh)"
    override val amountTooLarge = "The amount of your clients non-deductible loan interest must be less than £100,000,000,000 (Welsh)"
    override val amountTooSmall = "Enter a valid amount for the value of the non-deductible loan interest (Welsh)"
  }
}
