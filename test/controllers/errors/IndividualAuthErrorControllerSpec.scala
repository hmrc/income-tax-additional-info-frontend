...
class IndividualAuthErrorControllerSpec extends ControllerUnitTest {

  private val underTest = new IndividualAuthErrorController(inject[IndividualUnauthorisedView])
