...
import views.html.templates.SupportingAgentAuthErrorPageView

class SupportingAgentAuthErrorControllerSpec extends ControllerUnitTest {

  private val pageView: SupportingAgentAuthErrorPageView = app.injector.instanceOf[SupportingAgentAuthErrorPageView]
