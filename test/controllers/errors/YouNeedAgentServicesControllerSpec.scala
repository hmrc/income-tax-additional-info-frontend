...
class YouNeedAgentServicesControllerSpec extends ControllerUnitTest {

  private val underTest = new YouNeedAgentServicesController(inject[YouNeedAgentServicesView])
