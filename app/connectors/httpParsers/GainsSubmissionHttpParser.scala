...
object GainsSubmissionHttpParser extends Parser{
  type GainsSubmissionResponse = Either[ApiError, Int]

  override val parserName: String = "GainsSubmissionHttpParser"
  override val service: String = "income-tax-additional-information"

  implicit object GainsSubmissionResponseResponseReads extends HttpReads[GainsSubmissionResponse] {
