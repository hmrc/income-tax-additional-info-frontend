...
class CheckAnswersNonDeductibleControllerISpec extends IntegrationTest with UserAnswersStub with MockitoSugar with BeforeAndAfterEach {
  ...
  ".submit" should {
    ...
    "user is an Agent" should {
      ...
      "redirect to the 'Task List Page' page" in {
        authoriseAgentOrIndividual(isAgent = true)
        stubGetUserAnswers(taxYear, BusinessTaxReliefs)(userAnswers)
