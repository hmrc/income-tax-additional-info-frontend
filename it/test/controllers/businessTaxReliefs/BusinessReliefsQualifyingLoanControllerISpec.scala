  ...
  ".show" when {
    ...
    "user is an Agent" should {
      ...
      "render the Non Deductible amount page (page not previously answered)" in {
        ...
        contentAsString(result) must include(BusinessReliefsQualifyingLoanMessages.EnglishAgent.headingAndTitle)
      }
    }
    ...
    "user is an Agent" should {
      ...
      "invalid data is submitted" should {
        ...
        "render the page as a bad request" in {
          ...
          contentAsString(result) must include(BusinessReliefsQualifyingLoanMessages.EnglishAgent.amountEmpty)
        }
      }
    }
